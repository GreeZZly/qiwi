	...
	<br>	
			...
			<div class="top_rules">
				<div class="rules_read">
					<div class="title_form">Как работает MakeYourCash?</div>
					<div class="rules_general">
						1. Чтобы сделать вклад, вы должны быть авторизированы на сайте.<br><br>
						2. Вы покупаете киви яйцо на n-ую сумму, далее вставляете код ваучера в разделе "Баланс".<br><br>
						3. Как только администратор проверит ваш ваучер, вклад на 24 часа будет автоматически сделан в порядке очереди.<br><br>
						4. Через 24 часа у вас на балансе появится ваш вклад + 30% прибыли.<br><br>
						5. После того, как вы получили ваш заработок, вы можете вложить свои деньги еще на 24 часа, либо вывести их, в разделе "Вывести".<br><br>
						Администрация проверяет и выводит деньги в порядке очереди. То есть когда администрация проверит вашу запрошенную сумму, у вас появится ваучер, который вы сможете активировать в своем QIWI кошельке.
					</div>
				</div>
			</div>
<br><br><br>		
